...
\ee
which is saturated for $\lambda = 1$, independent of the parameters $a$, $b$ and $q$ and only values of $\lambda \geq 1$ are allowed. Since experimentally $\lambda \leq 0.6$ such simple quintessence models are excluded by our conjecture.
