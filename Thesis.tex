...
\begin{figure}[H]
\centering
\includegraphics[scale=0.75]{quevedo_314_3D_large.pdf}
\end{figure}
\begin{figure}[H]
\centering
...
\\\newpage This expression can be plugged back into the scalar potential \eqref{eq:genscal} which yields that:
\be 
