...
\be 
F \sim \sqrt{m^2_{\frac{3}{2}} + H^2 } M_P^2\,,
\ee
...
\bea
K &= K_{b4} + \rme^{K_{b4}} \frac{S\bar{S}}{V_{Dp}}\,,\\
W &= W_{b4} + S\,.
\label{eq:newsugra}
\eea
...
\paragraph{Our next example will be intersecting $D6$-branes} which are also the main motivation of our considerations here.
