...
Here, we will use solutions like the ones discussed in the previous section in order to constrain the parameters $a$, $b$ and $q$ appearing in our conjecture \eqref{eq:ourdScon}.
